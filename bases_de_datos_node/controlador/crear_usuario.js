    ...
    Usuario.find({}, (err, usuarios) => {
      if (err) {
        ...
        if (usuarios.length <= 0) {
			...
			nuevoUsuario1.nombre = 'Marco Antonio Calleros'
			nuevoUsuario1.email = 'marco.calleros@gmail.com'
			...
			nuevoUsuario2.nombre = 'Lizette Zendejas'
			nuevoUsuario2.email = 'lixalderete@gamil.com'
